...
> **Note**: PyCharm Professional is required for Docker remote interpreters and Docker Compose integration. Community Edition doesn't support these features in the same way.
